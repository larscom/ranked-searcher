class RankedSearcher < Formula
  ...
  on_macos do
    on_intel do
      url "https://github.com/larscom/ranked-searcher/releases/download/0.0.2/rs-0.0.2-macos-x86_64.tar.gz"
      sha256 "2b3cdcbac23a84457a308d833fc7e8f32b5b1695409c5513c7079c472eb9fbf3"
    end

    on_arm do
      url "https://github.com/larscom/ranked-searcher/releases/download/0.0.2/rs-0.0.2-macos-arm64.tar.gz"
